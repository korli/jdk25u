...
/*
 * Class:     sun_hawt_Clipboard
 * Method:    initIDs
 * Signature: ()V
 */
JNIEXPORT void JNICALL
Java_sun_hawt_HaikuClipboard_initIDs(JNIEnv *env, jclass clazz)
{
    clipboardChangedMethod = env->GetStaticMethodID(clazz, "clipboardChanged", "()V");
}
