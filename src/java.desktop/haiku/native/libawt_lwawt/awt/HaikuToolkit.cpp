...
jmethodID acceptFileMethod;
jmethodID doneMethod;
jmethodID handleActionMethod;
jmethodID clipboardChangedMethod;
...
Java_sun_hawt_HaikuToolkit_nativeSyncQueue(JNIEnv *env, jobject thiz, jlong timeout)
{
